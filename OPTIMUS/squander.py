...
for opt_method in ["Bfgs", "Pso", "Genetic", "Multistart", "iPso", "Price", "gende", "de", "Tmlsl", "gcrs",
    "IntegerGenetic", "ParallelGenetic", "DoubleGenetic", "NeuralMinimizer", "ParallelDe", "parallelPso"]:
    ret = [None]
    def runfunc():
