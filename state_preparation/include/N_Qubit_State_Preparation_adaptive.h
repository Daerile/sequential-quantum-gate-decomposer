...
*/
/*! \file N_Qubit_State_Preparation_adaptive.h
    \brief Header file for a class to determine the decomposition of an N-qubit unitary into a sequence of CNOT and U3 gates.
*/

#ifndef N_Qubit_State_Preparation_adaptive_H
#define N_Qubit_State_Preparation_adaptive_H
...
*/
class N_Qubit_State_Preparation_adaptive : public N_Qubit_Decomposition_adaptive {
...
@return An instance of the class
*/
N_Qubit_State_Preparation_adaptive( Matrix Umtx_in, int qbit_num_in, int level_limit_in, int level_limit_min_in );
...
@return An instance of the class
*/
N_Qubit_State_Preparation_adaptive( Matrix Umtx_in, int qbit_num_in, int level_limit_in, int level_limit_min_in, std::vector<matrix_base<int>> topology_in );
...
*/
virtual ~N_Qubit_State_Preparation_adaptive();
...
*/
virtual void start_state_preparation(bool prepare_export=true);
