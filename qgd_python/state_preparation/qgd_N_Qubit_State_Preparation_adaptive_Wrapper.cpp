...
*/
/*
\file qgd_N_Qubit_State_Preparation_adaptive_Wrapper.cpp
...
/**
@brief Type definition of the qgd_N_Qubit_State_Preparation_adaptive_Wrapper Python class of the qgd_N_Qubit_State_Preparation_adaptive_Wrapper module
*/
typedef struct qgd_N_Qubit_State_Preparation_adaptive_Wrapper {
    PyObject_HEAD
    /// pointer to the unitary to be decomposed to keep it alive
    PyObject *Umtx;
    /// An object to decompose the unitary
    N_Qubit_State_Preparation_adaptive* decomp;
    /// a pointer to base class represented by the decomposing classes
    N_Qubit_Decomposition_Base* decomp_base;

} qgd_N_Qubit_State_Preparation_adaptive_Wrapper;
...
create_N_Qubit_State_Preparation_adaptive( Matrix& state, int qbit_num, int level_limit, int level_limit_min, std::vector<matrix_base<int>> topology_in ) {

    return new N_Qubit_State_Preparation_adaptive( state, qbit_num, level_limit, level_limit_min, topology_in );
}



/**
@brief Call to deallocate an instance of N_Qubit_State_Preparation_adaptive class
@param ptr A pointer pointing to an instance of N_Qubit_Decomposition class.
*/
void
release_N_Qubit_State_Preparation_adaptive( N_Qubit_State_Preparation_adaptive*  instance ) {
...
/**
@brief Method called when a python instance of the class qgd_N_Qubit_State_Preparation_adaptive_Wrapper is destroyed
@param self A pointer pointing to an instance of class qgd_N_Qubit_State_Preparation_adaptive_Wrapper.
*/
static void
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_dealloc(qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self)
{

    if ( self->decomp != NULL ) {
        // deallocate the instance of class N_Qubit_Decomposition
        release_N_Qubit_State_Preparation_adaptive( self->decomp );
        self->decomp = NULL;
    }
...
/**
@brief Method called when a python instance of the class qgd_N_Qubit_State_Preparation_adaptive_Wrapper is allocated
@param type A pointer pointing to a structure describing the type of the class qgd_N_Qubit_State_Preparation_adaptive_Wrapper.
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self;
    self = (qgd_N_Qubit_State_Preparation_adaptive_Wrapper *) type->tp_alloc(type, 0);
    if (self != NULL) {}
...
/**
@brief Method called when a python instance of the class qgd_N_Qubit_State_Preparation_adaptive_Wrapper is initialized
@param self A pointer pointing to an instance of the class qgd_N_Qubit_State_Preparation_adaptive_Wrapper.
...
*/
static int
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_init(qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args, PyObject *kwds)
{
    // The tuple of expected keywords
    static char *kwlist[] = {(char*)"Umtx", (char*)"qbit_num", (char*)"level_limit", (char*)"level_limit_min", (char*)"topology", NULL};
    ...
    if (qbit_num > 0 ) {
        self->decomp = create_N_Qubit_State_Preparation_adaptive( Umtx_mtx, qbit_num, level_limit, level_limit_min, topology_Cpp);
...
/**
@brief Wrapper function to call the start_state_decomposition method of C++ class N_Qubit_Decomposition
@param self A pointer pointing to an instance of the class qgd_N_Qubit_State_Preparation_adaptive_Wrapper.
@param args A tuple of the input arguments: finalize_decomp (bool), prepare_export (bool)
@param kwds A tuple of keywords
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_Start_State_Preparation(qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args, PyObject *kwds)
{
    ...
    if (  self->decomp != NULL ) {
        self->decomp->start_state_preparation(prepare_export);
    }
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_get_gate_num( qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_get_gate( qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_get_gates( qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_List_Gates( qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_get_Optimized_Parameters( qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Optimized_Parameters( qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Max_Layer_Num(qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Iteration_Loops(qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Verbose(qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Debugfile(qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Optimization_Tolerance(qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Convergence_Threshold(qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Optimization_Blocks(qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Gate_Structure( qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_N_Qubit_State_Preparation_adaptive_Wrapper_Reorder_Qubits(qgd_N_Qubit_State_Preparation_adaptive_Wrapper *self, PyObject *args ) {
...
/**
@brief Structure containing metadata about the members of class qgd_N_Qubit_State_Preparation_adaptive_Wrapper.
*/
static PyMemberDef qgd_N_Qubit_State_Preparation_adaptive_Wrapper_members[] = {
    {NULL}  /* Sentinel */
};

/**
@brief Structure containing metadata about the methods of class qgd_N_Qubit_State_Preparation_adaptive_Wrapper.
*/
static PyMethodDef qgd_N_Qubit_State_Preparation_adaptive_Wrapper_methods[] = {
    {"Start_State_Preparation", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_Start_State_Preparation, METH_VARARGS | METH_KEYWORDS,
     "Method to start the decomposition."
    },
    {"get_Gate_Num", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_get_gate_num, METH_NOARGS,
     "Method to get the number of decomposing gates."
    },
    {"get_Optimized_Parameters", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_get_Optimized_Parameters, METH_NOARGS,
     "Method to get the array of optimized parameters."
    },
    {"set_Optimized_Parameters", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Optimized_Parameters, METH_VARARGS,
     "Method to set the initial array of optimized parameters."
    },
    {"get_Gate", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_get_gate, METH_VARARGS,
     "Method to get the i-th decomposing gates."
    },
    {"get_Gates", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_get_gates, METH_NOARGS,
     "Method to get the tuple of decomposing gates."
    },
    {"List_Gates", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_List_Gates, METH_NOARGS,
     "Call to print the decomposing nitaries on standard output"
    },
    {"set_Max_Layer_Num", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Max_Layer_Num, METH_VARARGS,
     "Call to set the maximal number of layers used in the subdecomposition of the qbit-th qubit."
    },
    {"set_Iteration_Loops", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Iteration_Loops, METH_VARARGS,
     "Call to set the number of iteration loops during the subdecomposition of the qbit-th qubit."
    },
    {"set_Verbose", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Verbose, METH_VARARGS,
     "Call to set the verbosity of the qgd_N_Qubit_Decomposition class."
    },
    {"set_Debugfile", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Debugfile, METH_VARARGS,
     "Set the debugfile name of the N_Qubit_Decomposition class."
    },
    {"set_Gate_Structure", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Gate_Structure, METH_VARARGS,
     "Call to set adaptive custom gate structure in the decomposition."
    },
    {"Reorder_Qubits", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_Reorder_Qubits, METH_VARARGS,
     "Wrapper method to reorder the qubits in the decomposition class."
    },
    {"set_Optimization_Tolerance", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Optimization_Tolerance, METH_VARARGS,
     "Wrapper method to set the optimization tolerance of the optimization process during the decomposition."
    },
    {"set_Convergence_Threshold", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Convergence_Threshold, METH_VARARGS,
     "Wrapper method to set the threshold of convergence in the optimization processes."
    },
    {"set_Optimization_Blocks", (PyCFunction) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_set_Optimization_Blocks, METH_VARARGS,
...
/**
@brief A structure describing the type of the class qgd_N_Qubit_State_Preparation_adaptive_Wrapper.
*/
static PyTypeObject qgd_N_Qubit_State_Preparation_adaptive_Wrapper_Type = {
  PyVarObject_HEAD_INIT(NULL, 0)
  "qgd_N_Qubit_State_Preparation_adaptive_Wrapper.qgd_N_Qubit_State_Preparation_adaptive_Wrapper", /*tp_name*/
  sizeof(qgd_N_Qubit_State_Preparation_adaptive_Wrapper), /*tp_basicsize*/
  0, /*tp_itemsize*/
  (destructor) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_dealloc, /*tp_dealloc*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  qgd_N_Qubit_State_Preparation_adaptive_Wrapper_methods, /*tp_methods*/
  qgd_N_Qubit_State_Preparation_adaptive_Wrapper_members, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  0, /*tp_descr_get*/
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  (initproc) qgd_N_Qubit_State_Preparation_adaptive_Wrapper_init, /*tp_init*/
  0, /*tp_alloc*/
  qgd_N_Qubit_State_Preparation_adaptive_Wrapper_new, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
*/
static PyModuleDef qgd_N_Qubit_State_Preparation_adaptive_Wrapper_Module = {
    PyModuleDef_HEAD_INIT,
    .m_name = "qgd_N_Qubit_State_Preparation_adaptive_Wrapper",
...
*/
PyMODINIT_FUNC
PyInit_qgd_N_Qubit_State_Preparation_adaptive_Wrapper(void)
{
    // initialize Numpy API
    import_array();

    PyObject *m;
    if (PyType_Ready(&qgd_N_Qubit_State_Preparation_adaptive_Wrapper_Type) < 0)
        return NULL;

    m = PyModule_Create(&qgd_N_Qubit_State_Preparation_adaptive_Wrapper_Module);
    if (m == NULL)
        return NULL;

    Py_INCREF(&qgd_N_Qubit_State_Preparation_adaptive_Wrapper_Type);
    if (PyModule_AddObject(m, "qgd_N_Qubit_State_Preparation_adaptive_Wrapper", (PyObject *) &qgd_N_Qubit_State_Preparation_adaptive_Wrapper_Type) < 0) {
        Py_DECREF(&qgd_N_Qubit_State_Preparation_adaptive_Wrapper_Type);
        Py_DECREF(m);
        return NULL;
    }
