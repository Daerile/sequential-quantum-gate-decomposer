...
/**
@brief Wrapper function to add a Y gate to the front of the gate structure.
@param self A pointer pointing to an instance of the class Gates_Block.
@param args A tuple of the input arguments: target_qbit (int)
@param kwds A tuple of keywords
*/
...
/**
@brief Wrapper function to add a Z gate to the front of the gate structure.
@param self A pointer pointing to an instance of the class Gates_Block.
@param args A tuple of the input arguments: target_qbit (int)
@param kwds A tuple of keywords
*/
...
static PyMethodDef qgd_Gates_Block_Methods[] = {
    ...
    {"add_Y", (PyCFunction) qgd_Gates_Block_add_Y, METH_VARARGS | METH_KEYWORDS,
     "Call to add a X gate to the front of the gate structure"
    },
    {"add_Z", (PyCFunction) qgd_Gates_Block_add_Z, METH_VARARGS | METH_KEYWORDS,
     "Call to add a X gate to the front of the gate structure"
    },
